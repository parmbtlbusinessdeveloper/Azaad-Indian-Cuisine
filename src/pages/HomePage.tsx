          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-screen py-20">
            ...
            <div className="text-white space-y-8 fade-in">
              <div className="space-y-6">
                ...
                <p className="text-xl md:text-2xl text-yellow-200 font-medium leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  ...
                  className="bg-gradient-to-r from-yellow-500 to-orange-500 text-red-900 px-8 py-4 rounded-full font-bold text-lg hover:from-yellow-400 hover:to-orange-400 transition-all duration-300 transform hover:scale-105 shadow-lg text-center"
                >
                  Order Now
                </a>
                <a 
                  href="#menu"
                  className="border-2 border-yellow-300 text-yellow-300 px-8 py-4 rounded-full font-semibold text-lg hover:bg-yellow-300 hover:text-red-900 transition-all duration-300 flex items-center justify-center space-x-2"
                >
                  <span>View Menu</span>
                  <ArrowRight size={20} />
                </a>
            ...
            <div className="flex flex-col items-center space-y-6 fade-in">
                ...
                <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-2xl overflow-hidden border-4 border-yellow-400/20">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center text-white">
                      ...
                      <p className="text-lg font-semibold">Kitchen in Action</p>
                      <p className="text-sm text-gray-300">See our chefs at work</p>
                    </div>
                  </div>
              ...
              <a 
                href="/gallery"
                className="bg-white/10 backdrop-blur-sm text-white px-6 py-3 rounded-full font-semibold hover:bg-white/20 transition-all duration-300 border border-white/20 flex items-center space-x-2"
              >
                <Play size={18} />
